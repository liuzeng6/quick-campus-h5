<template>
	<view class="nav">
		...
		<view class="nav-head" v-if="isHome" :style="'height:' + height + 'rpx;line-height:' + height +'rpx;padding-left:20rpx;background-color:#f3f3f3'">
			<text class="school-name">长幼校园圈</text>
			<view style="flex: 1;">
				<navigator url="/pages/search/index"
					:style="'height:' + menu.height * 2 + 'rpx;line-height:' + lineHeight + 'rpx;margin-top:' +
